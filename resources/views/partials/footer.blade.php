        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <span class="font-bold text-2xl">UAS Store</span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    @if(!auth()->check() || auth()->user()->role !== 'admin')
                        <li>
                            <a href="/shop" class="text-gray-400 hover:text-white transition-colors flex items-center space-x-2">
                    ...
                    @auth
                        @if(auth()->user()->role === 'admin')
                            <li>
                                <a href="/admin/dashboard" class="text-gray-400 hover:text-white transition-colors flex items-center space-x-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                    <span>Dashboard</span>
                            ...
                            <li>
                                <a href="/admin/products" class="text-gray-400 hover:text-white transition-colors flex items-center space-x-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                    <span>Produk</span>
                            ...
                            <li>
                                <a href="/admin/categories" class="text-gray-400 hover:text-white transition-colors flex items-center space-x-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                    <span>Kategori</span>
                        ...
                        @else
                            <li>
                                <a href="/my-transactions" class="text-gray-400 hover:text-white transition-colors flex items-center space-x-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                    ...
                    @else
                        <li>
                            <a href="/login" class="text-gray-400 hover:text-white transition-colors flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                                <span>Login</span>
                        ...
                        <li>
                            <a href="/register" class="text-gray-400 hover:text-white transition-colors flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                                <span>Register</span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-gray-500 text-sm">
                    &copy; {{ date('Y') }} <span class="text-white font-semibold">UAS E-Commerce</span>. All rights reserved.
                </p>
                <div class="flex items-center space-x-6">
                    ...
                    <a href="#" class="text-gray-500 hover:text-white text-sm transition-colors">FAQ</a>
                </div>
            </div>
        </div>
    </div>
