...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-900">Data Kategori</h2>
                <p class="text-gray-600 mt-2">Kelola kategori produk toko Anda</p>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <form action="/admin/categories/{{ $c->id }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                                        @csrf 
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                ...
                                <a href="/admin/categories/create" class="mt-4 inline-flex items-center text-blue-600 hover:text-blue-800">
