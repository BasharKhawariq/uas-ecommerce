            ...
            <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-yellow-500">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($todayIncome, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
